...
#import "_UIInteractionProgressObserver.h"

@class CloudTabItemView, CloudTabTable, GradientView, HighlightRecognizer, LinearClassifierLongPressGestureRecognizer, NSArray, NSMutableSet, NSString, NSTimer, ReorderingAutoscroller, TabExplanationView, TiltedTabItem, UIImage, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIPreviewForceInteractionProgress, UIScrollView, UITapGestureRecognizer, WBSCloudTab;
