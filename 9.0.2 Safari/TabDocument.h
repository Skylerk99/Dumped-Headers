...
#import "WBUFormAutoFillControllerDelegate.h"
...
@class BrowserController, FindOnPageCompletionProvider, LinkPreviewViewController, LoadingController, NSDictionary, NSError, NSMutableArray, NSMutableSet, NSString, NSTimer, NSURL, NSUUID, NSUserActivity, PageLoadTest, PageLoadTestStatistics, PinnableBanner, QuickLookDocument, QuickLookDocumentController, QuickLookDocumentWriter, ReaderContextWK2, SafariSharingExtensionController, SafariWebView, StoreBanner, TabBarItem, TabOverviewItem, TiltedTabItem, UIImage, UIView, WBSAutomaticReadingListItem, WBSFluidProgressController, WBSFluidProgressState, WBSHistoryVisit, WBUFormAutoFillController, WBUInjectedJavaScriptController, WBUWebClipMetadataFetcher, WKBackForwardListItem, WebBookmark, _SFDownloadController, _SFFluidProgressView, _SFJavaScriptDialogManager, _SFNavigationBarItem, _SFPageLoadErrorController, _SFSafeBrowsingController, _SFURLSpoofingMitigator, _WKDownload, _WKRemoteObjectInterface, _WKSessionState;

@interface TabDocument : NSObject <AppBannerMetaTagContentObserver, FindOnPageToolbarDelegate, LoadingControllerDelegate, QuickWebsiteSearchEventListener, RequestDesktopSiteUIProcessListener, StoreBannerDelegate, WBSFluidProgressStateSource, WBSFluidProgressControllerWindowDelegate, WBUFormAutoFillControllerDelegate, WKNavigationDelegatePrivate, WKUIDelegatePrivate, _WKFindDelegate, _WKFormDelegate, _WKDiagnosticLoggingDelegate>
{
