...
@class CADisplayLink, CloudTabItemView, GradientView, HighlightRecognizer, NSArray, NSIndexSet, NSString, NSTimer, ReorderingAutoscroller, TabExplanationView, TabOverviewInterpolatedLocation, TabOverviewItem, UIButton, UILongPressGestureRecognizer, UIPanGestureRecognizer, UISearchBar, UITapGestureRecognizer;
