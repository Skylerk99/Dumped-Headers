...
@class CompletionListGroup, FindOnPageCompletionProvider, NSArray, NSDate, NSString, NSTimer, QuickWebsiteSearchCompletionProvider, ReadingListCompletionProvider, SearchQueryRestorationCompletionItem, SearchSuggestionProvider, URLCompletionProvider, UniversalSearchCompletionProvider, WBSBookmarkAndHistoryCompletionMatch, WBSCompletionQuery, WBSParsecHiddenResultInfo, WBSParsecSearchSession;
...
@property(readonly, nonatomic) WBSParsecHiddenResultInfo *parsecHiddenResultInfo; // @synthesize parsecHiddenResultInfo=_parsecHiddenResultInfo;
