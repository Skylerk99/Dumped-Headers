...
#import "WBSParsecSportsScoreSummaryCardSection.h"

#import "SearchUIScoreSummaryCardSection.h"

@class NSArray, NSString, NSURL;

@interface WBSParsecSportsScoreSummaryCardSection (SearchUIConformance) <SearchUIScoreSummaryCardSection>
