...
@protocol GCDWebServerDelegate, OS_dispatch_queue, OS_dispatch_group, OS_dispatch_source;
...
@property (assign,nonatomic) id<GCDWebServerDelegate> delegate;                          //@synthesize delegate=_delegate - In the implementation block
...
-(NSArray *)handlers;
-(void)setDelegate:(id<GCDWebServerDelegate>)arg1 ;
-(void)dealloc;
-(id)init;
-(id<GCDWebServerDelegate>)delegate;
-(void)stop;
-(BOOL)isRunning;
