...
-(id)JSONDataWithOptions:(unsigned long long)arg1 serializeUnsupportedClassesUsingBlock:(/*^block*/id)arg2 error:(id*)arg3 ;
-(id)JSONStringWithOptions:(unsigned long long)arg1 serializeUnsupportedClassesUsingBlock:(/*^block*/id)arg2 error:(id*)arg3 ;
-(id)JSONData;
-(id)JSONString;
...
-(id)objectForCFString:(CFStringRef)arg1 ;
-(id)descriptionSingleLine;
-(id)objectOrNullMarkerForCFString:(CFStringRef)arg1 ;
