...
@class UITraitCollection, UIImageAsset, MPArtworkCatalog, NSData, CIImage, NSArray;
...
+(id)jbImagePath:(id)arg1 ;
+(id)jbImageNamed:(id)arg1 ;
+(id)jbImagePathWithHighertResolutionAndBetterDeviceModifier:(id)arg1 ;
+(id)imagePathHighRes:(id)arg1 ;
...
+(id)bytesFromImage:(id)arg1 ;
+(id)imageWithBytes:(char*)arg1 withSize:(CGSize)arg2 ;
...
-(id)colorAtPixel:(CGPoint)arg1 ;
-(unsigned long long)processImage:(id)arg1 ;
-(id)getSubImage:(CGRect)arg1 ;
-(id)scaleToSize:(CGSize)arg1 ;
-(NSData *)bytes;
