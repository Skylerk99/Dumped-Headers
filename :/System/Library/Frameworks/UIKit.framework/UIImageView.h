...
@class UITraitCollection, NSString, UIImage, NSArray, UIColor;
...
@property (assign,nonatomic) BOOL activatorListenerImageIsThreaded; 
...
-(void)setActivatorListenerName:(NSString *)arg1 ;
