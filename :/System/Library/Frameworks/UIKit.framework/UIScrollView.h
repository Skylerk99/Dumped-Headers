...
@class UIImageView, _UIStaticScrollBar, UIView, UIScrollViewPinchGestureRecognizer, UISwipeGestureRecognizer, NSISVariable, NSArray, ISScrollViewVitalityController, UIPanGestureRecognizer, UIPinchGestureRecognizer, NSString;
