...
@property (readonly) SCD_Struct_NS47 operatingSystemVersion; 
...
-(SCD_Struct_NS47)operatingSystemVersion;
...
-(BOOL)isOperatingSystemAtLeastVersion:(SCD_Struct_NS47)arg1 ;
