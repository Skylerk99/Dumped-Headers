...
-(void)encodeCMTime:(SCD_Struct_NS10)arg1 forKey:(id)arg2 ;
-(SCD_Struct_NS10)decodeCMTimeForKey:(id)arg1 ;
-(void)encodeCMTimeRange:(SCD_Struct_NS11)arg1 forKey:(id)arg2 ;
-(SCD_Struct_NS11)decodeCMTimeRangeForKey:(id)arg1 ;
-(void)encodeCMTimeMapping:(SCD_Struct_NS12)arg1 forKey:(id)arg2 ;
-(SCD_Struct_NS12)decodeCMTimeMappingForKey:(id)arg1 ;
