...
@property (readonly) SCD_Struct_NS59 UIKBHandwritingPointValue; 
...
+(id)valueWithCMTimeRange:(SCD_Struct_NS11)arg1 ;
+(id)valueWithCMTimeMapping:(SCD_Struct_NS12)arg1 ;
+(id)valueWithCMTime:(SCD_Struct_NS10)arg1 ;
+(id)valueWithUIKBHandwritingPoint:(SCD_Struct_NS59)arg1 ;
+(id)valueWithCGRect:(CGRect)arg1 ;
...
-(SCD_Struct_NS12)CMTimeMappingValue;
-(SCD_Struct_NS11)CMTimeRangeValue;
-(SCD_Struct_NS10)CMTimeValue;
-(SCD_Struct_NS59)UIKBHandwritingPointValue;
