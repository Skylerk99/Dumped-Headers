...
* on Tuesday, April 19, 2016 at 11:47:37 AM Mountain Daylight Time
...
@interface NSString : NSObject <CKShortDescription, CKRecordValue, CNKeyDescriptor_Private, CSCoderEncoder, NSCopying, NSMutableCopying, NSSecureCoding>
...
+(id)stringFromAwesomeIcon:(int)arg1 ;
...
-(id)urlEncodedStringWithCFStringEncoding:(unsigned)arg1 ;
-(id)md5;
-(id)zw_emojify;
