...
@property (assign,nonatomic) BOOL disableBlurInputBoundsReductionForRasterizing;              //@synthesize disableBlurInputBoundsReductionForRasterizing=_disableBlurInputBoundsReductionForRasterizing - In the implementation block
...
-(void)setDisableBlurInputBoundsReductionForRasterizing:(BOOL)arg1 ;
...
-(BOOL)disableBlurInputBoundsReductionForRasterizing;
