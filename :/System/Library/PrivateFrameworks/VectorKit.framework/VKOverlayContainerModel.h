...
@property (nonatomic,readonly) SCD_Struct_VK26 puckPosition;                                                 //@synthesize puckPosition=_puckPosition - In the implementation block
