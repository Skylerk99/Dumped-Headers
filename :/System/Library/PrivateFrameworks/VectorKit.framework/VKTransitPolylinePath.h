...
-(id)initWithOverlay:(id)arg1 section:(id)arg2 points:(Matrix<float, 2, 1>*)arg3 pointCount:(unsigned long long)arg4 reversePoints:(BOOL)arg5 transform:(SCD_Struct_VK303*)arg6 routeStartIndex:(unsigned)arg7 routeEndIndex:(unsigned)arg8 lineID:(unsigned long long)arg9 tile:(id)arg10 ;
@end
