...
-(void)_populateIconImageKeysFromTransitAccessPointFeature:(SCD_Struct_VK363*)arg1 ;
-(void)_populateImageKeysFromTransitLineFeature:(SCD_Struct_VK364*)arg1 ;
-(BOOL)isOneWayArrow;
...
-(BOOL)isTextVisible;
-(BOOL)isTransit;
-(void)_populateRelatedTextForTransitAccessPointFeature:(SCD_Struct_VK363*)arg1 ;
...
-(void)_populateImageKeysFromTransitAccessPointFeature:(SCD_Struct_VK363*)arg1 ;
-(id)subtext;
-(NSArray *)imageKeys;
